...
function vowelCount(str){
    ...
    return str.toLowerCase().split("").reduce(function(accumulator, nextValue, index, array){
        if(vowels.indexOf(nextValue) !== -1 && !(nextValue in accumulator)){
            accumulator[nextValue] = 1;
        } else if(nextValue in accumulator) {
...
var result = addKeyAndValue(arr2, 'title', 'Instructor');
console.log(result);
