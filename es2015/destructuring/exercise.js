...
function createStudent({likesES2015=true, likesJavaScript=true} = {}){
    ...
    if(likesES2015 && likesJavaScript){
        str += "The student likes JavaScript and ES2015";
        return str;
    }
    if(likesES2015 && !likesJavaScript) {
        str += "The student likes ES2015!" ;
        return str;
    }
    if(!likesES2015 && likesJavaScript){
        str += "The student likes JavaScript";
        return str;
    }
    if(!likesES2015 && !likesJavaScript){
        str += "The student does not like much...";
        return str;
    }
...
function reverseArray(arr){
    ...
    //arr[2] = arr[lastIndex - 2]
    //....
    //arr[middle] = arr[lastIndex - middle]

    for(let i = 0; i < middle; i++){
        [newArr[i], newArr[lastIndex - i]] = [newArr[lastIndex - i], newArr[i]];
    }
    return newArr;
}
